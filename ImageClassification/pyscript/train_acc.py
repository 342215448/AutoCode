...
if __name__ == "__main__":
    ...
    parser.add_argument("--chldata", type=str, default='',
                        help="Whether or not use torch file as trian data")
    ...
    if args.chldata:
        print('loading data...')
        train_dataset = torch.load(args.chldata)
        print('done...')
        # 划分训练集和验证集
    ...
    # 定义优化器
    optimizer = optim.AdamW(model.parameters(), lr=3e-5/args.gradientAccu)
